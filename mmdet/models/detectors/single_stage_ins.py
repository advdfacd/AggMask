...
class SingleStageInsDetector(BaseDetector):
    ...
    def forward_train(self,
        ...
        loss_inputs = outs + (
        self.bbox_head.learned_weight_kernel_shape, self.bbox_head.learned_weight_number_per_layer, gt_bboxes,
        gt_labels, gt_masks, img_metas, self.train_cfg)
    ...
    def simple_test(self, img, img_meta, rescale=False):
        ...
        seg_inputs = outs + (self.bbox_head.learned_weight_kernel_shape, self.bbox_head.learned_weight_number_per_layer, img_meta, self.test_cfg, rescale)
