...
def coco_eval(result_files,
    ...
    for res_type in result_types:
        if isinstance(result_files, str):
            ...
            result_file=result_files # pass result file directly without dumping
        else:
...
def results2json_segm(dataset, results, out_file, dump=True):
    if dump:
        result_files = dict()
        ...
        result_files = segm2json_segm(dataset, results)
    return result_files
